...
from dsl2coru.pb_codec import decode_protobuf, encode_protobuf
from dsl2coru.schema_registry import schema_for_verb
...
def roundtrip_text(line: str, *, default_file: str | None = None) -> str:
    ...
    wire = envelope_from_bytes(envelope_to_bytes(payload, default_file=default_file or ""))
    return to_text(wire)
