...
_DEFAULT_PLUGIN_VERSION="$(python -c 'from koruide.plugin_version import EXPECTED_VSCODE_PLUGIN_VERSION; print(EXPECTED_VSCODE_PLUGIN_VERSION)')"
export KORU_FAKE_EXTENSION_VERSION="${KORU_FAKE_EXTENSION_VERSION:-${_DEFAULT_PLUGIN_VERSION}}"
