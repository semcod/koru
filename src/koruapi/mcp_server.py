...
from koruapi.mcp_server_dispatch import handle_tools_call as _dispatch_handle_tools_call
from koruapi.mcp_server_dispatch import handle_tools_list as _dispatch_handle_tools_list
from koruapi.mcp_server_dispatch import handle_initialize as _dispatch_handle_initialize
...
# ---------------------------------------------------------------------------
# Tool schema (MCP tools/list response)
# ---------------------------------------------------------------------------
...
def _handle_initialize(params: dict[str, Any]) -> dict[str, Any]:
    return _dispatch_handle_initialize(
        params,
...
def _handle_tools_list(params: dict[str, Any]) -> dict[str, Any]:
    return _dispatch_handle_tools_list(params, tools=TOOLS)


def _handle_tools_call(params: dict[str, Any]) -> dict[str, Any]:
    return _dispatch_handle_tools_call(params, tool_dispatch=_TOOL_DISPATCH)
