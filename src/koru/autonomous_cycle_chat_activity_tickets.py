"""
Backward compatibility shim for koru.autonomy.cycle.cycle_chat_activity_tickets module migration.

This module maintains backward compatibility by re-exporting from the new
autonomy.cycle.cycle_chat_activity_tickets submodule. Remove this shim after one release.
"""
...
from koru.autonomy.cycle import cycle_chat_activity_tickets as _module_impl  # noqa: F401
