"""
Backward compatibility alias for koru.autonomy.operator.operator_up.

The old copy-attributes shim desynced monkeypatches: patching
``koru.autonomous_up.<name>`` mutated the shim's copy while the implementation
...
Remove after one release once callers import koru.autonomy.operator.operator_up.
"""

import sys

from koru.autonomy.operator import operator_up as _module_impl
