...
def _normalize_photo_vql_drive_result(photo_res: dict[str, Any], *, ide: str, submit: bool) -> dict[str, Any]:
    ...
    return normalize_drive_result(
        ...
        policy=DriveResultPolicy(
            trusted_visual_target_id=_trusted_visual_target_id,
            surface_target_safe=_surface_bounds_target_safe_for_actuation,
            allow_capture_mismatch=_allow_actuation_on_capture_mismatch,
            allow_map_source_mismatch=_map_source_mismatch_actuation_allowed,
        ),
    )
