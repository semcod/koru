"""
Backward compatibility alias for koru.autonomy.cycle.cycle_bridge.

The old copy-attributes shim desynced monkeypatches: patching
``koru.autonomous_cycle_bridge.<name>`` mutated the shim's copy while the implementation
...
Remove after one release once callers import koru.autonomy.cycle.cycle_bridge.
"""

import sys

from koru.autonomy.cycle import cycle_bridge as _module_impl
