"""
Backward compatibility shim for koru.autonomy.cycle.cycle_chat_activity_text module migration.

This module maintains backward compatibility by re-exporting from the new
autonomy.cycle.cycle_chat_activity_text submodule. Remove this shim after one release.
"""
