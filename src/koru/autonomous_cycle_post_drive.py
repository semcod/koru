"""
Backward compatibility shim for koru.autonomy.cycle.cycle_post_drive module migration.

This module maintains backward compatibility by re-exporting from the new
autonomy.cycle.cycle_post_drive submodule. Remove this shim after one release.
"""
...
from koru.autonomy.cycle import cycle_post_drive as _module_impl  # noqa: F401
import sys
