...
from koru.doctor_runtime_checks import (
    ...
    _installed_koru_version,  # noqa: F401
...
def _build_readiness_result(
    ...
    """Build a ReadinessResult from issues list, handling common logic."""
    ok = not any(i.severity == "fail" for i in issues)
    if primary_fix is None:
        primary_fix = _first_fix_command(issues) if issues else None
...
def evaluate_autonomous_readiness(
    ...
    *,
    ...
    return _build_readiness_result(merged, primary_fix=primary)
