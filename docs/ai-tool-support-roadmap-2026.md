...
Deliverables:
- `docs/ai-tool-registry-2026.yaml` with fields:
...
- Handoff markdown uses this registry as the source of truth.

Exit criteria:
- 100% tools from target inventory present in registry.
...
## Phase 3 — Native lane expansion (highest ROI)
