...
6. **R13** (focused-window arbitration) — pick up after plugin coverage is universal.

**Status snapshot:** 12/14 refactor items shipped (R1, R2, R3, R4, R5, R6, R7, R9, R10, R11, R12, R14 ✅; R8 🟡). Remaining: R13.
