...
*375 nodes · 500 edges · 74 modules · CC̄=3.8*

### Hubs (by degree)

| Function | CC | in | out | total |
|----------|----|----|-----|-------|
| `print` *(in project)* | 0 | 1051 | 0 | **1051** |
...
# code2llm | 1060f 170568L | python:779,typescript:94,shell:60,json:41,yaml:31,toml:16,yml:12,kotlin:6,txt:5,proto:4,go:2,javascript:1,rust:1,properties:1,xml:1 | 2026-07-18
# generated in 1.53s
# CC̅=3.8 | critical:16/7410 | dups:0 | cycles:0
...
HEALTH[16]:
  ...
  🟡 CC    _run_next_planfile_task_impl CC=20 (limit:15)
  🟡 CC    validate_subactor_repair_template CC=33 (limit:15)
  🟡 CC    variables_from_development_defect CC=17 (limit:15)
  🟡 CC    hydrate_subactor_repair_ticket CC=20 (limit:15)
  🟡 CC    resolve_verify_command CC=17 (limit:15)
  🟡 CC    apply_proposed_patch CC=27 (limit:15)
  🟡 CC    _stage_patch_in_worktree CC=15 (limit:15)
...
LAYERS:
  ...
  │ !! patch_transaction          392L  0C    5m  CC=27     ←1
  ...
  │ !! ticket_templates           264L  0C   11m  CC=33     ←2
  ...
  │ patch_retry                145L  0C    3m  CC=14     ←1
  ...
  │ __init__                     1L  0C    0m  CC=0.0    ←0
  │
  scripts/                        CC̄=2.8    ←in:0  →out:87  !! split
  ...
  │ subactor-development-repair-pilot   239L  0C   12m  CC=6      ←0
...
COUPLING:
                       ...
                       src.koru                             ──                            622                            223                              4                             14                             59                              3                             ←3                             22                             12                             ←3                             25                             ←2                             18                             ←1  hub
                        project                           ←622                             ──                            ←26                           ←183                            ←17                                                           ←11                            ←83                            ←12                            ←22                            ←11                             ←6                             ←7                                                            ←6  hub
                    src.koruide                             40                             26                             ──                            ←28                            ←27                              9                                                                                                                           1                                                                                                                                                             hub
                  packages.coru                             42                            183                             28                             ──                                                             3                              3                                                            ←1                                                                                            4                                                                                               hub
                    src.koruapi                            100                             17                             27                                                            ──                             13                                                            ←1                              2                                                                                                                           3                              3                                 hub
  plugins.koru-autopilot-shared                            ←59                                                            ←9                             ←3                            ←13                             ──                                                                                           ←2                                                                                                                          ←2                                                                hub
              packages.dsl2koru                             ←3                             11                                                             1                                                                                           ──                                                                                                                         ←34                             ←2                                                                                            1  hub
                        scripts                              3                             83                                                                                            1                                                                                           ──                                                                                                                                                                                                                           !! fan-out
  ...
  HUB: plugins.koru-autopilot-shared/ (fan-in=92)
  HUB: koru/ (fan-in=22)
  ...
  SMELL: scripts/ fan-out=87 → split needed
...
# code2llm/evolution | 7265 func | 690f | 2026-07-18
# generated in 0.04s
...
NEXT[10] (ranked by impact):
  ...
  [3] !! SPLIT-FUNC      apply_proposed_patch  CC=27  fan=28
      WHY: CC=27 exceeds 15
      EFFORT: ~1h  IMPACT: 756

  [4] !! SPLIT-FUNC      validate_subactor_repair_template  CC=33  fan=15
      WHY: CC=33 exceeds 15
      EFFORT: ~1h  IMPACT: 495

  [5] !  SPLIT-FUNC      discover_bootstrap_candidates  CC=18  fan=27
      WHY: CC=18 exceeds 15
      EFFORT: ~1h  IMPACT: 486

  [6] !  SPLIT-FUNC      _run_next_planfile_task_impl  CC=20  fan=22
      WHY: CC=20 exceeds 15
      EFFORT: ~1h  IMPACT: 440

  [7] !  SPLIT-FUNC      _merge_call_graph_locations  CC=22  fan=17
      WHY: CC=22 exceeds 15
      EFFORT: ~1h  IMPACT: 374

  [8] !  SPLIT-FUNC      _code2llm_cc_locations  CC=20  fan=16
      WHY: CC=20 exceeds 15
      EFFORT: ~1h  IMPACT: 320

  [9] !  SPLIT-FUNC      hydrate_subactor_repair_ticket  CC=20  fan=15
      WHY: CC=20 exceeds 15
