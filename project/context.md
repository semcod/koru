...
- **Languages**: python: 356, shell: 49, typescript: 29, yaml: 22, yml: 9
...
- **Calls**: src.koruide.plugin_installer.install_plugin_for_ide, stdio_info, str, src.koruide.plugin_installer.format_plugin_install_result, stdio_info, None.strip, getattr, stdio_info
...
- `src.koru.autonomous_operator.setup_autopilot_plugin` - 32 calls
...
graph TD
    ...
    setup_autopilot_plug --> format_plugin_instal
    run_api_request --> get
