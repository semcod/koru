...
- **Languages**: python: 758, typescript: 94, shell: 58, json: 41, yaml: 31
- **Analysis Mode**: static
- **Total Functions**: 7222
- **Total Classes**: 497
- **Modules**: 1036
- **Entry Points**: 2720
...
graph TD
    ...
    run_daemon_command --> install_koruide_host
    run_daemon_command --> gc_stale_sockets_for
```
