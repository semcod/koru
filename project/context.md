...
- **Languages**: python: 400, typescript: 55, shell: 49, yaml: 23, json: 16
- **Analysis Mode**: static
- **Total Functions**: 4477
- **Total Classes**: 333
- **Modules**: 571
- **Entry Points**: 2018
...
- **Calls**: msg.data.get, koruide.ide.normalize_ide_id, bool, bool, daemon.log, daemon._plugin_for, daemon.log, src.koruide.daemon.handlers._drive_via_keyboard
