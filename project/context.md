...
- **Languages**: python: 154, shell: 42, yaml: 15, yml: 8, typescript: 6
- **Analysis Mode**: static
- **Total Functions**: 1427
- **Total Classes**: 103
- **Modules**: 240
- **Entry Points**: 505
...
- `src.koru.autopilot.install_manager.collect_install_manager_report` - 23 calls
