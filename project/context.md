...
- **Languages**: python: 91, shell: 37, yaml: 14, yml: 8, kotlin: 6
...
- **Calls**: isinstance, text.strip, obj.get, obj.get, src.koruide.protocol._filter_extras, Message, ProtocolError, json.loads
